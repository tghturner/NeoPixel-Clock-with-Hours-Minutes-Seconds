...
#define PIN            D1        // digital pin on ESP8266 for the NeoPixel data line
...
void drawHands(){
  ...
  if (hour_hand==minute_hand) {
    pixels.setPixelColor(minute_hand,pixels.Color(0,100,100));
  } else {
    pixels.setPixelColor(minute_hand,pixels.Color(0,0,100));
  }
